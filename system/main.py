    ...
    for i in range(args.prev, args.times):
        ...
        if model_str == "MLR":  # convex
            if "MNIST" in args.dataset:
                ...
                args.model = Mclr_Logistic(14, num_classes=args.num_classes).to(
                    args.device
                )
            else:
            ...
            if "MNIST" in args.dataset:
                ...
                args.model = DNN(14, 64, num_classes=args.num_classes).to(args.device)
            else:
...
if __name__ == "__main__":
    ...
    # FairFed / FedALAFair - Fairness parameters
    parser.add_argument(
        "-fl",
        "--fairness_lambda",
        type=float,
    ...
    parser.add_argument(
        ...
        type=int,
        default=-1,
        help="Index of sensitive attribute in features (e.g., sex column index)",
    )
